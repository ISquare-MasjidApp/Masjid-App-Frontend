    ...
    return (
        <div className="bg-white border border-[var(--border-01)] rounded-[12px] p-4 hover:shadow-[0_4px_21px_rgba(0,0,0,0.1)] transition-shadow">
            <div className="flex justify-between items-start mb-2">
                <h3 className="font-urbanist font-semibold text-[16px] text-[var(--grey-800)] line-clamp-1">
                    {announcement.title}
                </h3>
            ...
            <p className="font-urbanist text-[14px] text-[var(--grey-100)] mb-3 line-clamp-2">
                {announcement.description}
            </p>

            <div className="flex items-center gap-2 text-[var(--brand)]">
                <CalendarIcon size={14} />
                <span className="font-urbanist text-[12px] font-medium">{announcement.date}</span>
            </div>
        </div>
    );
}
