            ...
            <div className="p-6 space-y-6">
                ...
                <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2">
                    ...
                    <div className="flex items-start gap-4">
                        <div className="w-[175px] shrink-0 text-[16px] font-medium font-urbanist text-[#666d80]">
                            Event Title
                        </div>
                        <div className="text-[16px] font-medium font-urbanist text-[var(--grey-800)]">
                            {event.title}
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 space-y-4">
                            <div className="text-[16px] font-medium font-urbanist text-[var(--grey-800)] whitespace-pre-wrap">
                    ...
                    <p className="text-[12px] font-urbanist text-[#696969] mt-4">
                ...
                <div className="flex justify-end gap-6 pt-4 border-t border-gray-100">
                    <button
                        ...
                        className="flex items-center gap-2 h-[44px] px-[24px] border border-[var(--border-01)] rounded-[12px] text-[16px] font-medium font-urbanist text-[#4b4b4b] hover:bg-gray-50 transition-colors"
                    >
                        <EditIcon size={20} />
                        Edit
                    </button>
