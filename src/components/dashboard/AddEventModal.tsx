        ...
        <Modal isOpen={isOpen} onClose={onClose} className="max-w-[800px] p-0 overflow-hidden">
            <div className="p-6 space-y-6">
                ...
                <div className="flex justify-between items-start">
                    <h2 className="text-[24px] font-bold font-urbanist text-[var(--grey-800)]">
                ...
                <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
                    ...
                    <div className="space-y-2">
                        <label className="block text-[16px] font-semibold font-urbanist text-[#4b4b4b] tracking-[0.16px]">
                            Event Title
                        </label>
                        <div className="relative">
                            <input
                                ...
                                placeholder="Title"
                                className="w-full h-[48px] px-[21px] border border-[var(--border-01)] rounded-[12px] text-[16px] font-urbanist text-[var(--grey-800)] placeholder:text-[#8e8e8e] focus:outline-none focus:ring-1 focus:ring-[var(--brand)]"
                            />
                        </div>
                    </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <button className="w-full h-[48px] px-[21px] border border-[var(--border-01)] rounded-[12px] flex items-center justify-between bg-white hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-[var(--brand)]">
                                    <span className="text-[16px] font-urbanist text-[var(--grey-800)]">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full h-[120px] p-[21px] border border-[var(--border-01)] rounded-[12px] text-[16px] font-urbanist text-[var(--grey-800)] placeholder:text-[#8e8e8e] focus:outline-none focus:ring-1 focus:ring-[var(--brand)] resize-none"
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="block text-[16px] font-semibold font-urbanist text-[#4b4b4b] tracking-[0.16px]">
                                Registration Link <span className="font-normal font-urbanist">(Optional)</span>
                            </label>
                            <input
                                type="text"
                                value={link}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="block text-[16px] font-semibold font-urbanist text-[#4b4b4b] tracking-[0.16px]">
                                Upload Image <span className="font-normal font-urbanist">(Optional)</span>
                            </label>
                            <label className="flex items-center justify-between w-full h-[48px] px-[21px] border border-[var(--border-01)] rounded-[12px] cursor-pointer hover:bg-gray-50 transition-colors">
                                <span className={`text-[16px] font-urbanist ${imageName ? 'text-[var(--grey-800)]' : 'text-[#8e8e8e]'}`}>
                    ...
                    <p className="text-[12px] font-urbanist text-[#696969]">
                ...
                <div className="flex justify-end gap-6 pt-4 border-t border-gray-100">
                    <button
                        onClick={onClose}
                        className="h-[44px] px-[24px] border border-[var(--border-01)] rounded-[12px] text-[16px] font-medium font-urbanist text-[#4b4b4b] hover:bg-gray-50 transition-colors"
                    >
                        Cancel
                    </button>
                    <div className="flex items-center gap-6">
                        ...
                        <button
                            onClick={handleSave}
                            className="h-[44px] px-[24px] bg-[var(--brand)] rounded-[12px] text-[16px] font-medium font-urbanist text-white hover:bg-[var(--brand-06)] transition-colors shadow-sm"
                        >
