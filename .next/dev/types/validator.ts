...
// Validate ../../../src/app/(dashboard)/prayer-management/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/prayer-management">> = Specific
  const handler = {} as typeof import("../../../src/app/(dashboard)/prayer-management/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
